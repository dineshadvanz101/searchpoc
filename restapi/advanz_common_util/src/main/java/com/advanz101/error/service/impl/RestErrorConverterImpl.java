...
public class RestErrorConverterImpl implements RestErrorConverter {
	...
	public static RestErrorResponse restErrorConvertor(RestErrorDomainImpl restErrorDomainImpl) {
		return new RestErrorResponse(populateApiErrorObject(restErrorDomainImpl), restErrorDomainImpl.getMetadata(),
				null);
	}
	...
	public static RestErrorResponse customExceptionConverter(CustomRestErrorDomainImpl customRestErrorDomainImpl) {
		return new RestErrorResponse(populateApiErrorObject(customRestErrorDomainImpl),
				customRestErrorDomainImpl.getMetadata(),
	...
	private static ApiErrorMessage populateApiErrorObject(BaseRestErrorDomain restErrorDomain) {
		...
		UserErrorMessage userMessageError = new UserErrorMessage(restErrorDomain.getUserMessage(),
				restErrorDomain.getFieldMessages());
		return new ApiErrorMessage(systemMessageError, userMessageError, null);
	}
